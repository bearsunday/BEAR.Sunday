...
if(function_exists('print_a')):
    ...
    public function pre($string, $options_string = NULL)
    {
    ...
    public function pre_die($string, $options_string = NULL)
    {
        if(!$GLOBALS['USE_DEBUGLIB']) return;
    ...
    public function script_runtime($label = '', $style = '', $return_mode = FALSE)
    {
        $bt = debug_backtrace();
        $bt = $bt[1];
        $title = "({$bt['line']}) {$bt['file']}";
    ...
    public function print_a($input, $options_string = NULL)
    {
        if(!$GLOBALS['USE_DEBUGLIB']) return;
    ...
    public function print_a_die($input, $options_string = NULL)
    {
        if(!$GLOBALS['USE_DEBUGLIB']) return;
    ...
    // deprecated
    public function die_a($input, $options_string = NULL)
    {
        if(!$GLOBALS['USE_DEBUGLIB']) return;
    ...
    public function show_vars($options_string = NULL)
    {
        if(!$GLOBALS['USE_DEBUGLIB']) return;
    ...
    public function print_mysql_result($mysql_result, $return_mode = FALSE)
    {
        if(!$GLOBALS['USE_DEBUGLIB']) return;
