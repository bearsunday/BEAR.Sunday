...
class CliTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $cli = 'php ' . $this->systemRoot . '/apps/Sandbox/public/web.php get /index';
        exec($cli, $return);
    ...
    {
        $cli = 'php ' . $this->systemRoot . '/apps/Sandbox/public/api.php get page://self/index';
        exec($cli, $return);
        $html = implode('', $return);
    ...
    {
        $cli = 'php ' . $this->systemRoot . '/apps/Sandbox/public/api.php get page://self/index view';
        exec($cli, $return);
        $html = implode('', $return);
        $pos = strpos($html, 'Hello, BEAR.Sunday');
    ...
    {
        $cli = 'php ' . $this->systemRoot . '/apps/Sandbox/public/api.php get page://self/index value';
        exec($cli, $return);
        $html = implode('', $return);
        $pos = strpos($html, 'Hello, BEAR.Sunday');
        $this->assertTrue(is_int($pos));
    ...
    {
        $cli = 'php ' . $this->systemRoot . '/apps/Sandbox/public/api.php get page://self/index request';
        exec($cli, $return);
        $html = implode('', $return);
        $pos = strpos($html, 'Hello, BEAR.Sunday');
        $this->assertTrue(is_int($pos));
